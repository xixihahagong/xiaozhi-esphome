...
namespace Lang {
    ...
    namespace Strings {
        ...
        constexpr const char* BLE_NET_CONFIG = "请使用微信小程序\"小瑞Agent\"配网";
        constexpr const char* CHECKING_NEW_VERSION = "自检中...";
        ...
        constexpr const char* DEVICE_NAME_IS = "设备名称:";
        ...
        constexpr const char* ESPHOME_ENTITY_BUTTON_NAME_WAKEUP = "唤醒";
        constexpr const char* ESPHOME_ENTITY_NUMBER_NAME_VOLUME = "音量";
        constexpr const char* ESPHOME_ENTITY_SWITCH_NAME_MIC_ENABLE = "麦克风开关";
        constexpr const char* ESPHOME_ENTITY_TEXT_NAME_ASK_AND_EXECUTE_COMMAND = "询问后执行命令";
        constexpr const char* ESPHOME_ENTITY_TEXT_NAME_EXECUTE_COMMAND = "执行命令";
        constexpr const char* ESPHOME_ENTITY_TEXT_NAME_PLAY_VOICE = "播放语音";
        ...
        constexpr const char* WIFI_CONFIG_MODE_CONNECTING = "配网中...";
    }
